<?php
	...
	$also_anounced_images["es"] = '
		<ul class="announces acenter">
			<li>
				<a href="http://www.homelidays.es/alojamiento/p6421174">
					<img src="../img/homeaway.png" class="homeaway">
				</a>
			</li>
			<li>
				<a href="http://www.ownersdirect.co.uk/accommodation/p8114145n">
   ...
   <a href="https://www.facebook.com/pages/Villa-La-Torre/797972976937424">
	...
	$also_anounced_images["fr"] = '
		<ul class="announces acenter">
			<li>
				<a href="http://www.abritel.fr/location-vacances/p6421174a">
					<img src="../img/homeaway.png" class="homeaway">
				</a>
			</li>
			<li>
				<a href="http://www.ownersdirect.co.uk/accommodation/p8114145">
					<img src="../img/ownersdirect.png" class="ownersdirect">
				</a>
			</li>
			<!--<li>
	...
	$also_anounced_images["en"] = '
		<ul class="announces acenter">
			<li>
				<a href="http://www.homeaway.co.uk/p6421174">
					<img src="../img/homeaway.png" class="homeaway">
				</a>
			</li>
			<li>
...
Virtually on the sea (along the board walk) makes the peace and quiet guaranteed as you can only hear the sound of the waves! A two bedroom apartment on the beach, for holiday rental, located on the third and last floor of the building (with lift). With no roads to cross between you and the beach, the apartment is ideal for children and adults alike. The apartment building is set within it's own private courtyard, adjacent to the 5 star Perla Marina Hotel. Ideally located just 5 minute walk from the main shopping area of Nerja, which includes many cafes and restaurants to choose from. There are also two supermarkets nearby(2 minutes). The beautiful old town with its many shops, restaurants and bars is a 10 minute pleasant walk away and surrounds the Balcon de Europa, with its famous views of the coast and mountains..";

	$bedrooms["es"] = "Dormitorios:";
	$bedrooms["fr"] = "Dormitories:";
	$bedrooms["en"] = "Bedrooms:";

	$bedrooms_det["es"] = "Dormitorio 1 con 2 camas individuales juntas.<br> Dormitorio 2 con una cama individual.";
	$bedrooms_det["fr"] = "Chambre 1 avec deux lits simples ensemble.<br>Chambre 2 avec lit simple.";
	$bedrooms_det["en"] = "Bedroom 1 with twin beds joints.<br>Bedroom 2, with 1 bed.";

	$bathroom["es"] = "Baños";
	$bathroom["fr"] = "Salles de bain";
	$bathroom["en"] = "Bathrooms";

	$bathroom_det["es"] =   "Cuarto de baño con ducha, lavabo, inodoro.";
	$bathroom_det["fr"] =   "Salle de bain  avec douche, lavabo, wc.";
	$bathroom_det["en"] =   "Bathroom with shower, WC, and wash basin.";

	$kitchen["es"] = "Cocina:";
	$kitchen["fr"] = "Cuisine";
	$kitchen["en"] = "Kitchen:";

	$kitchen_det["es"] = "Equipada con:<br> horno microondas, frigorifico, lavadora, tostadora, cafetera, hervidor, etc.";
	$kitchen_det["fr"] = "Équipée avec:<br> four micro-ondes, réfrigérateur, machine à laver , grille-pain, cafetière, bouilloire etc.";
	$kitchen_det["en"] = "Fitted, including:<br> full oven, microwave, Refrigerator, washing machine, toaster,coffee maker, kettle, etc.";
...
Dépôt de 30% sont retournés à la fin.";
	...
	$more_reviews["es"] = 'Puedes leer más opiniones en <a href="http://www.homelidays.es/alojamiento/p6421174#reviews">homeaway.es</a> y en <a href="http://www.ownersdirect.co.uk/accommodation/p8114145#reviews">ownersdirect.co.uk</a>';
	$more_reviews["fr"] = 'Vous pouvez lire plus de commentaires dans <a href="http://www.abritel.fr/location-vacances/p6421174a#reviews">abritel.fr</a> et dans <a href="http://www.ownersdirect.co.uk/accommodation/p8114145#reviews">ownersdirect.co.uk</a>';
	$more_reviews["en"] = 'You can read more reviews in <a href="http://www.abritel.fr/location-vacances/p6421174a#reviews">ownersdirect.co.uk</a> and <a href="http://www.ownersdirect.co.uk/accommodation/p8114145#reviews">homeaway.co.uk</a>';

	$form_value["es"] = "Apartamento de la Playa";
	$form_value["fr"] = "Appartement Plage";
	$form_value["en"] = "Apartment Beach";
