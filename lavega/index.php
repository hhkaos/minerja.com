...
<!--[if gt IE 8]><!--> <html class="no-js" lang="" xmlns:fb="http://ogp.me/ns/fb#"> <!--<![endif]-->
    <head>
        ...
        <title>Villa La Vega in Nerja, Costa del Sol, Spain</title>
            		...
            		<div role="tabpanel">
					  ...
					  <div class="tab-content">
					    ...
					    <div role="tabpanel" class="tab-pane" id="location">
					    	<a 
					    		href="http://maps.google.es/maps/ms?ie=UTF8&hl=es&msa=0&msid=112550728994123716925.0004527ae1f5e545287e5&ll=36.744954,-3.900769&spn=0.004445,0.006866&t=h&z=17" 
					    		target="_blank"
					    	>
					    		<img src="https://maps.googleapis.com/maps/api/staticmap?center=36.744625,-3.901389&zoom=17&size=500x400&maptype=satellite&markers=color:blue%7C36.745587,-3.901404">
							</a>
					    </div>
					    <div role="tabpanel" class="tab-pane" id="reviews">
							...
							<div 
								class="fb-comments" 
								data-href="https://www.facebook.com/pages/Villa-La-Vega/452593368228422" 
								data-numposts="7"
     							data-width="100%"
					    ...
					    <div role="tabpanel" class="tab-pane" id="availability">
					    	...
					    	<p>
								<?php echo $availability_txt4[$l]; ?>
							</p>
							<ul>
							 	 <?php echo $availability_txt5[$l]; ?>
							</ul>
						    ...
						    <form action="?l=<?php echo $l; ?>"method="POST">
						    	...
						    	<p>
							    	<label>
							    		...
							    		<input type="text" name="subject" value="Villa La Vega">
							    	</label>
							    </p>
